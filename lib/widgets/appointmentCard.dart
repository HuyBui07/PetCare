...
class CustomAppointmentCard extends StatelessWidget {
  const CustomAppointmentCard({super.key, required this.dateTime});

  final String dateTime;

  @override
  Widget build(BuildContext context) {
    int idx = dateTime.indexOf('at');
    // TODO: implement build
    return Container(
      margin: EdgeInsets.only(
        left: scaleW(10, context),
        top: scaleH(10, context),
        right: scaleW(10, context),
      ),
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Padding(
                              padding:
                                  EdgeInsets.only(top: scaleH(10, context)),
                              child: Text(
                                '${dateTime.substring(0, idx).trim()} - ${dateTime.substring(idx + 2).trim()}',
                                style:
